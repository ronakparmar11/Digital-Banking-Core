...
export function CustomerAlertTrendChart({ data }: { data: CustomerTransactionTrendPoint[] }) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        {data.length === 0 ? (
          <p className="text-sm text-muted-foreground">No alerts in the trend window.</p>
        ) : (
